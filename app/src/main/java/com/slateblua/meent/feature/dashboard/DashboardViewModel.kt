...
class DashboardViewModel(
    ...
    fun changeTimeRange(timeRange: TimeRange) = intent {
    ...
    private fun loadAnalytics() = intent {
        ...
        try {
            ...
            postSideEffect(DashboardSideEffect.ShowError("Failed to load analytics"))
        }
    }
    ...
    private fun calculateStreaks(sessions: List<com.slateblua.meent.data.FocusModel>): Pair<Int, Int> {
    ...
    private fun calculateDailyBreakdown(sessions: List<com.slateblua.meent.data.FocusModel>, weekStart: Long): Map<String, Int> {
